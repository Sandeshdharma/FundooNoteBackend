    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotesTbl", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotesTbl_UserTbl_UserId",
                        column: x => x.UserId,
                        principalTable: "UserTbl",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Collaborators_NotesTbl_NoteId",
                        column: x => x.NoteId,
                        principalTable: "NotesTbl",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Collaborators_UserTbl_UserId",
                        column: x => x.UserId,
                        principalTable: "UserTbl",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NoteLabels_NotesTbl_NoteId",
                        column: x => x.NoteId,
                        principalTable: "NotesTbl",
                        principalColumn: "Id");
                });
